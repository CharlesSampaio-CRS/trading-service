...
/// ═══════════════════════════════════════════════════════════════════
/// 7 Templates padrão do sistema — estratégias clássicas de cripto
/// Cada template é autoexplicativo para que qualquer usuário entenda
/// ═══════════════════════════════════════════════════════════════════
...
/// GET /api/v1/strategy-templates - Lista todos os templates (7 padrão + do usuário)
#[get("")]
pub async fn get_templates(user: web::ReqData<Claims>, db: web::Data<MongoDB>) -> impl Responder {
    ...
    let defaults: Vec<StrategyTemplateResponse> = default_templates()
        ...
        .enumerate()
        .map(|(i, t)| {
            // IDs fixos para os defaults: "default_0" ... "default_6"
